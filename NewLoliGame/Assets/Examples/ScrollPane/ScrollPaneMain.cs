...
public class ScrollPaneMain : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log("_mainView.GetChild(\"box\")" + _mainView.GetChild("box"));
    ...
    void OnLongPress(EventContext context)
    {
        ...
        if (p == null)
            return;
        Debug.Log("OnLongPress: " + context.data);
        Debug.Log("obj: " + obj + "  "  + obj.parent);
        DragDropManager.inst.StartDrag(obj, obj.icon, obj.text);
        obj.asCom. onDrop.Add(onDrop);
    }
