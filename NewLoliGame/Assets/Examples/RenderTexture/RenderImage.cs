...
public class RenderImage
{
    ...
    public void LoadModel(string model)
    {
        ...
        // model = "Game/Spine Skeletons/spineboy-unity/spineboy-unity_SkeletonData";
        // Object prefab = Resources.Load(model);

        // skeletonDataAsset = prefab as SkeletonDataAsset; 
        // skeletonDataAsset.GetSkeletonData(false);

        //Object mat = Resources.Load("Game/Spine Skeletons/spineboy-unity/spineboy_Material");
        //Material material = mat as Material;
        //Debug.Log("oo: " + mat + "  "  + material);
        //Debug.Log("texture " + material.GetTexture("MainTex'"));
        //var sg = SkeletonGraphic.NewSkeletonGraphicGameObject(skeletonDataAsset, this.modelRoot, material); // Spawn a new SkeletonGraphic GameObject.
        //sg.gameObject.name = "SkeletonGraphic Instance";

        //// Extra Stuff
        //sg.Initialize(false); 
        //sg.Skeleton.SetSlotsToSetupPose();
        //sg.AnimationState.SetAnimation(0, "ani_shuyan_Idle", true);
        //sg.gameObject.layer = 5;
        //_model = sg.transform;
        //_model.gameObject.layer = 5;
        //this.modelRoot.gameObject.layer = 5; 
        ...
        GameObject go = ((GameObject)Object.Instantiate(tmpObj));
        _model = go.transform;
        go.SetActive(true);
        _model.SetParent(this.modelRoot, false);
