	...
	Properties
	{
		...
		SubShader
		{
			...
			fixed4 frag(v2f i) : SV_Target
			{
				...
				// 返回颜色，透明度部分乘以我们设定的值
				  //return fixed4(albedo + diffuse, texColor.a * _AlphaScale);
				  //texColor.rgb *= _AlphaScale;

				  //return fixed4(texColor * _Color);
				  return fixed4(texColor.rgb*  _AlphaScale,  texColor.a * _AlphaScale);
			  }
			  ENDCG
		  }
		}
