...
[ViewAttr("Game/UI/T_Common", "T_Common", "Frame_common_obtainattribute", true)]
public class CommonGetPropsView : BaseView
{
    GTextField numText;
    GLoader imgLoader;
    TinyItem tinyItem;
    ...
    public override void InitData<D>(D data)
    {
        ...
        if (tinyItem != null)
        {
            ...
            if (StoryView.view!=null && StoryView.view.ui.visible == true)
                return;
