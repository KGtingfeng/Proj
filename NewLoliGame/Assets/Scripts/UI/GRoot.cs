...
namespace FairyGUI
{
    ...
    public class GRoot : GComponent
    {
        ...
        {
            Stage.inst.PlayClickSound(audioClip);
        }
        ...
        {
            Stage.inst.PlayBgSound(audioClip);
        }

        public void StopBgSound()
        {
            Stage.inst.StopBgSound();
        }
        ...
        /// </summary>
        /// <param name="audioClip">Audio clip.</param>
        public void PlayDialogSound(AudioClip audioClip)
        {
            Stage.inst.PlayDialogSound(audioClip);
        }

        public void StopDialogSound()
        {
            Stage.inst.StopDialogSound();
        }
        ...
        /// 获取当前声音的播放状态
        /// </summary>
        /// <returns><c>true</c>, if dialog is playing was gotten, <c>false</c> otherwise.</returns>
        public bool GetDialogIsPlaying()
        {
            return Stage.inst.GetDialogIsPlayinng();
        }
 

        public void PlayEffectSound(AudioClip audioClip)
        {
            Stage.inst.PlayEffectSound(audioClip);
        }

        public void StopEffectSound()
        {
            Stage.inst.StopEffectSound();
        }
