...
namespace FairyGUI
{
    ...
    public class Stage : Container
    {
        ...
        /// 背景音乐
        /// </summary>
        public AudioSource _audioBackGround;
        /// <summary>
        /// 对话音乐
        /// </summary>
       public AudioSource _audioDialog;
        /// <summary>
        /// 音效
        /// </summary>
...
#pragma warning restore 0649
        ...
        public void EnableSound()
        {
            if (_audioClick == null)
            {
                _audioClick = gameObject.AddComponent<AudioSource>();
                _audioClick.bypassEffects = true;
                _audioBackGround = gameObject.AddComponent<AudioSource>();
                _audioBackGround.loop = true;
                _audioBackGround.bypassEffects = true;
                //_audioDialog = gameObject.AddComponent<AudioSource>();
                EnableDialogSound();
                _audioDialog.bypassEffects = true;

                _audioEffect = gameObject.AddComponent<AudioSource>();
                _audioEffect.bypassEffects = true;
        ...
        public void DisableSound()
        {
            if (_audioClick != null)
            {
                UnityEngine.Object.Destroy(_audioClick);
                _audioClick = null;
            }
            ...
            if (_audioBackGround != null)
            {
                ...
                UnityEngine.Object.Destroy(_audioBackGround);
                _audioBackGround = null;
            ...
            if (_audioDialog != null)
            {
                ...
                UnityEngine.Object.Destroy(_audioDialog);
                _audioDialog = null;
            }
        }
        ...
        /// 禁用对话音效
        /// </summary>
        public void DisableDialogSound()
        {
            if (_audioDialog != null)
            {
                UnityEngine.Object.Destroy(_audioDialog);
        ...
        {
            if (_audioClick != null && this.soundVolume > 0)
                _audioClick.PlayOneShot(clip, volumeScale * this.soundVolume);
        }
        ...
        {
            if (_audioClick != null && this.soundVolume > 0)
                _audioClick.PlayOneShot(clip, this.soundVolume);
        }
        ...
        public void PlayClickSound(AudioClip clip)
        {
            if (_audioClick != null && this.soundVolume > 0)
            {
                ...
                _audioClick.PlayOneShot(clip, 1f);
            }
        }
        ...
        {
            if (_audioBackGround != null && this.soundVolume > 0)
            {
                //_audioEffects.PlayOneShot(clip, this.soundVolume);
                //_audioBackGround.volume = 0.1f; //this.soundVolume;
                _audioBackGround.clip = clip;
        ...
        {
            if (_audioDialog != null && this.soundVolume > 0)
            {
                //_audioDialog.PlayOneShot(clip, this.soundVolume); 
                _audioDialog.PlayOneShot(clip, 1); 
            }
        ...
        /// 判断当前的声音是否在播放
        /// </summary>
        /// <returns><c>true</c>, if dialog is playinng was gotten, <c>false</c> otherwise.</returns>
        public bool GetDialogIsPlayinng()
        {
            if (_audioDialog == null)
                return false;


            return _audioDialog.isPlaying;
        }

        public void PlayEffectSound(AudioClip clip)
        {
            if (_audioEffect != null && this.soundVolume > 0)
            {
                //_audioDialog.PlayOneShot(clip, this.soundVolume);
                _audioEffect.PlayOneShot(clip, 1);
            }
