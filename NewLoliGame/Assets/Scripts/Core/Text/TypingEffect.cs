...
namespace FairyGUI
{
    ...
    public class TypingEffect
    {
        ...
        public bool needAlphaEffect = true;
        /// <summary>
        /// 
        /// </summary>
        ...
        public void Start()
        {
            ...
            back_text = _textField.text;
            //Debug.LogError(_textField.text + "  count: " + _textField.charPositions.Count);
        }
        ...
        System.Action printAllAction;
        /// <summary>
        /// 立刻显示所有需要打印的文本
        /// </summary>
        public void ShowAllRightNow(System.Action printAllAction = null)
        {
            isShowAll = true;
            ...
            WordAplhaEffect.instance.ShowRightNow();
            this.printAllAction?.Invoke();
            Cancel();
        }
        ...
        private void output(int vertCount)
        {
            ...
            if (needAlphaEffect)
                WordAplhaEffect.instance.PlayAlphaEffect(ref _textField, _vertIndex);
        }

        public System.Action outPutCallback = null;
        public float printTime = 0.1f;
        public float speed = 1.0f;
        public IEnumerator OutPut(System.Action action)
        {
            outPutCallback = action;
            while (Print())
            {
                float sd = printTime * speed;
